...
const SignUpPagePresenter: React.FC<IsignUpPagePresnter> = ({
  getStageHolderClassName,
  FormComponent,
}) => {
  return (
    <>
          ...
          <main className={styles["signup-page-signup-form-container"]}>
            <div className={styles["signup-header-wrapper"]}>
              ...
              <div className={styles["signup-stage-holder"]}>
                <div
                  className={`${styles["signup-stage-holder-item"]} ${
                    styles[getStageHolderClassName(1)]
                  }`}
                >
                  <div
                    data-current={1}
                ...
                <div
                  className={`${styles["signup-stage-holder-item"]} ${
                    styles[getStageHolderClassName(2)]
                  }`}
                >
                  <div
                    data-current={2}
                ...
                <div
                  className={`${styles["signup-stage-holder-item"]} ${
                    styles[getStageHolderClassName(3)]
                  }`}
                >
                  <div
                    data-current={3}
